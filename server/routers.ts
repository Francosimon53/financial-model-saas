...
export const appRouter = router({
  ...
  projects: router({
    ...
    // Alias for getById used by client
  ...
  // Financial statements router (client code uses trpc.financial namespace)
  financial: router({
  ...
  ai: router({
    analyzeProject: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        const projectData = {
          ...
          revenueProducts: await db.getRevenueProducts(input.projectId),
          cogsItems: await db.getCogsItems(input.projectId),
          salaries: await db.getSalaries(input.projectId),
          opexItems: await db.getOpexItems(input.projectId),
          fixedExpenses: await db.getFixedExpenses(input.projectId),
          capexItems: await db.getCapexItems(input.projectId),
          fundingSources: await db.getFundingSources(input.projectId),
        };

        return await aiAnalysis.analyzeProjectFinancials(projectData);
      }),
    ...
    getRecommendations: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        return await aiAnalysis.generateCostOptimizationRecommendations(projectData);
      }),
    ...
    generateForecast: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        return await aiAnalysis.generateRevenueForecast(projectData);
      }),
    ...
    generateReport: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        const analysis = await aiAnalysis.analyzeProjectFinancials(projectData);
        return {
          report: await aiAnalysis.generateExecutiveReport(projectData, analysis),
          analysis
        };
      }),
  }),
